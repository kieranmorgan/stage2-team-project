...
/**
 * @author Evan Hosking and Kieran Morgan
...
public class ValidateRegistration {
    ...
    /**
     * checks that the user's information is all present and correct
     * @param firstName
     * @param lastName
     * @param phoneNumber
     * @param emailAddress
    ...
    public boolean validateEmail(TextInputLayout emailAddress) {
        ...
        else if (Patterns.EMAIL_ADDRESS.matcher(value).matches() && value.contains(".ac.uk")) {
